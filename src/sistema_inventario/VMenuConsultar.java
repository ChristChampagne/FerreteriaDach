...
/**
 * Clase VMenuConsultar con extensión JFrame e implementacIón de un ActionListener
 * Dentro de esta clase se encuentra la ventana para consultar los registros que se
 * encuentran dentro del inventario de la empresa "Ferreteria DACH". Inlcuye un botón
...
super();
	...
	public void actionPerformed(ActionEvent e) {
		...
		/* Acciones del botón generar archivo*/
